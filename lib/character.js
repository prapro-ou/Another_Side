...
class Player extends Character {
  constructor(id, y = 0, offensive_base_power,offensive_increase_amount, attack_interval, attack_method) {
    super(id, y);
    this.x               = 100;
