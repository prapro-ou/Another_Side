...
export class Skeleton_knight extends Player {
  constructor(y) {
    super(0, y, 400, 50, 2, 0, 0, 10000, 30000, 30000);
  }
  start_skill(players){
...
export class Slime extends Player {
  constructor(y) {
    super(1, y, 100, 50, 2, 0, 0, 1000, 15000, 15000);
  }
  start_skill(){
...
export class Ghost1 extends Player {
  constructor(y) {
    super(2, y, 200, 50, 5, 2, 10, 10000, 20000, 10000);
  }
  start_skill(){
...
export class Goblin_archer extends Player {
  constructor(y) {
    super(3, y, 300, 50, 3, 0, 0, 15000, 30000, 20000);
  }
  start_skill(){
...
export class Mummy extends Player {
  constructor(y) {
    super(4, y, 150, 50, 3, 0, 0, 10000, 30000, 2000);
...
export class Ghost2 extends Player {
  constructor(y) {
    super(5, y, 300, 50, 3, 1, 50, 15000, 30000, 6000);
...
export class Assasin extends Player {
  constructor(y) {
    super(6, y, 200, 50, 1, 0, 0, 20000, 40000, 0);
  }
  start_skill(attacks){
