...
export const EnemyArray = [
    [new Enemy(1,800,50,100,1.0,0),new Enemy(2,800,300,110,1.1,0),new Enemy(3,800,90,120,1.2,2),new Enemy(4,800,110,130,1.3,2),new Enemy(1,800,130,100,1.0,2),new Enemy(2,800,150,110,1.1,4)],
